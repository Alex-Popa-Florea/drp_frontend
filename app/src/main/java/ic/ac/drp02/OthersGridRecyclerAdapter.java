...
public class OthersGridRecyclerAdapter extends RecyclerView.Adapter<OthersGridRecyclerAdapter.MyViewHolder> {

    ArrayList<WardrobeItem> wardrobeItems;
    Context context;
    Fragment fragment;
    public OthersGridRecyclerAdapter(Context context, ArrayList<WardrobeItem> wardrobeItems, Fragment fragment) {
    ...
    public void onBindViewHolder(MyViewHolder holder, @SuppressLint("RecyclerView") int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                bundle.putInt("id", wardrobeItems.get(position).getId());

                NavHostFragment.findNavController(fragment).navigate(R.id.action_global_othersItemDetails, bundle);
